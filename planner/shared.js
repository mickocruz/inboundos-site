...
function plSidebar(active) {
  const items = [
    { id: 'board', href: '/planner', label: 'Board', icon: '<rect x="3" y="3" width="7" height="18" rx="1"/><rect x="14" y="3" width="7" height="10" rx="1"/>' },
    { id: 'focus', href: '/planner/focus', label: 'Focus', icon: '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="1" fill="currentColor"/>' },
    { id: 'habits', href: '/planner/habits', label: 'Habits', icon: '<path d="M20 6L9 17l-5-5"/>' },
    { id: 'fitness', href: '/planner/fitness', label: 'Fitness', icon: '<path d="M6.5 6.5h11v11h-11z"/><path d="M2 12h2.5M19.5 12H22M12 2v2.5M12 19.5V22"/>' },
  ];
  ...
  return `<nav class="sidebar">
    <div class="sidebar-logo-wrap" onclick="location.href='/planner'"><div class="sidebar-logo-text"><span style="color:#fff;">Inbound</span><span style="color:#4FC3F7;">OS</span> <span style="font-size:11px;color:rgba(255,255,255,0.42);font-family:var(--font-data);font-weight:500;letter-spacing:1px;">PLANNER</span></div></div>
    ...
    <div class="nav-section"><div class="nav-section-label">Apps</div>
      <div class="nav-item" onclick="location.href='/dashboard'"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>Dashboard</div>
    </div>
    <div class="sidebar-bottom"><div class="mk-avatar-wrap"><img src="/micko.jpg" alt="MK" style="width:32px;height:32px;object-fit:cover;border-radius:50%;border:1px solid rgba(79,195,247,0.2);"/><div><div class="mk-name">Micko Cruz</div><div class="mk-role">Founder · InboundOS</div></div></div></div>
  </nav>`;
}
